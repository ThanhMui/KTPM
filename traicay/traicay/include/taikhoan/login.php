		...
		<tr>
			...
			<form action="" method="post" name="formdangnhap">
			    ...
			    <table width="220" height="105" cellpadding="0" cellspacing="0" border="0" style="border:#CCCCCC 1px solid; margin-top:3px;">
                  ...
                  <tr>
                    <td width="150" align="center"  height="25"><span class="demuc">Tên đăng nhập</span> </td>
                    <td width="70"><input name="txttendangnhap" type="text" id="txttendangnhap" style="width:120px;" value="<?php echo (isset($tendangnhap)?$tendangnhap:''); ?>" autocomplete="off"/>                    </td>
                  </tr>
                  <tr>
