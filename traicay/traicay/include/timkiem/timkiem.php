...
<table width="150" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<form action="" method="post" name="timkiem">
				...
				<table width="150" height="85" cellpadding="0" cellspacing="0" border="0" style="border:#CCCCCC 1px solid; margin-top:3px;">
					<tr>
						<td height="5">
						</td>
					</tr>
					<tr>
						<td height="30" align="center" style="text-align:center;padding:5px;">
									...
									<input type="text" name="txttim" value="" style="width:120px;background-color:white;padding:5px;color:black" placeholder="Tìm kiếm...">
						</td>
					</tr>	
					<tr>
						<td height="30" align="center" style="text-align:center">
						
									<input type="button" name="Button" value="Tìm kiếm" style="color:black;width:130px;padding:5px" onclick="timkiem_onsubmit()">
						</td>
					</tr>
					<tr>
