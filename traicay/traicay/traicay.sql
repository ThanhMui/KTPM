...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 10, 2020 lúc 06:28 AM
...
(8, 'hien', 2, '123456', 'Nguyễn', 'Hiền', 1),
(9, 'hai', 2, '123456', 'Trần', 'Hải', 1),
(10, 'huong', 2, '123456', 'Lê', 'Hương', 0),
(11, 'hieu', 2, '123456', 'Tô', 'Hiếu', 1),
(12, 'admin', 1, '123456', 'admin', 'admin', 0);
...
(43, 49, '2020-06-10 03:16:57', '22/06/2020', ' 66 ADV', 1),
(42, 49, '2020-06-08 13:24:53', '17/06/2020', ' 66 ADV', 0);
...
(49, 'Người', 'Dùng', 934154126, ' 66 ADV', 'nguoidung@gmail.com', 2, 'nguoidung', '123456');
...
(21, 1, 'Bưởi Năm Roi', 50000, 'buoinamroi.jpg', 'Bưởi Năm Roi được nhập từ khu vực Vĩnh Long', '2020-06-06 10:02:44', 1),
(41, 5, 'Bơ Sáp Hà Lan', 120000, 'Bơ Sáp.jpg', 'Loại bơ sáp này được xuất sứ từ đất nước Hà Lan', '2015-06-09 04:43:09', 0),
(42, 1, 'Măng Cụt', 50000, 'Măng cụt 1.JPG', 'Măng cụt là loại trái cây cực kỳ thơm ngon và bổ dưỡng.', '2020-06-06 09:58:07', 0);
...
--
ALTER TABLE `adm`
  MODIFY `ma_adm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `dondathang`
--
ALTER TABLE `dondathang`
  MODIFY `ma_dh` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
