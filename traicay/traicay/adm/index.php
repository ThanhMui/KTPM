...
<table width="400" border="0" class="admintable" cellpadding="2" cellspacing="0" align="center" style="margin-top:200px; border-right:solid 1px #E9E9E9; border-top:solid 1px #E9E9E9; background:url(../images/security.png) no-repeat right;">
  ...
  <tr>
    <td colspan="3" align="center"><input type="submit" name="Submit" style="background:#FFFFFF; color:#000000;" value="Đăng Nhập" /></td>
  </tr>
</table>
</form>
...
<?php } else { ?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="960" align="center" style="margin-top:20px; margin-bottom:20px; background:#FFFFFF;">
		<tr>
			<td height="40" style="color:#FFFFFF; background:#840002;" colspan="2" align="center">
		...
		<tr>
			<td width="200" valign="top" style="border-right: 1px #840002 solid; border-left: 1px #840002 solid;">
			<div class="menuleft">
			...
			border:#840002 solid 1px; border-right:none; border-left:none;">
			<p class="pp">
			...
			<div style="margin-top:4px;padding:10px; background:#66A111; color:#FFFFCC; border:1px #840002 solid; 
		...
		<tr>
			<td colspan="2" height="30" style="color:#FFFFCC; background:#840002;" align="center" valign="middle">
			Hệ thống quản lí cửa hàng bán trái cây - Nhóm Web 2. 
			</td>
		</tr>
	</table>
